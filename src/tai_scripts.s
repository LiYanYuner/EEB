...
DISCOURAGE_BERRYDRUM:
    ...
    jumpifbytevarEQ 1 POINTS_MINUS10
    jumpifhealthLT 60 bank_ai POINTS_MINUS10
...
DISCOURAGE_SKETCH:
    ...
    jumpifwordvarEQ 0xFFFF POINTS_MINUS10 @ Verifica MOVE_NONE (0xFFFF)
    return_cmd
################################################################################################
...
DISCOURAGE_COUNTER: @ Para movescript 44 (Counter/Mirror Coat/Metal Burst)
    ...
    jumpifstatus2 bank_target STATUS2_CONFUSION LIGHT_PENALTY
    jumpifstatus2 bank_target STATUS2_INLOVE LIGHT_PENALTY
    jumpifstatus bank_target STATUS_SLEEP LIGHT_PENALTY
    jumpifstatus bank_target STATUS_FREEZE LIGHT_PENALTY
    jumpifstatus bank_target STATUS_PARALYSIS LIGHT_PENALTY
    @ Verifica situação de movimento previsto
    getpartnerchosenmove
    jumpifwordvarEQ 0 CHECK_NO_PREDICTED_MOVE
...
TAI_SCRIPT_2: @ENCOURAGE a fatal move; bitfield 0x4, AI_CheckViability
	jumpiftargetisally END_LOCATION
